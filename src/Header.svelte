...
<header
  ...
  <div class="flex justify-between px-4 py-3">
    <div class="px-2">
      <img
        class="h-7 w-full"
        src="https://ve5wdo6qrlhsvngxnawfi3vmgpgw5yswnht7myr75h7moawdekqa.arweave.net/qTthu9CKzyq012gsVG6sM81u4lZp5_ZiP-n-xwLDIqA"
        alt="BΔNDPLΔY" />
    </div>
      ...
      <div class="hidden">
        ...
        <input
          class="block w-full border border-transparent bg-gray-200
            ...
            text-gray-900 rounded-lg pl-10 pr-4 py-2 truncate"
        ...
        <div
          ...
          {#if isLoggedIn}
            ...
            <button
              ...
              aria-label="Menu"
              class="block px-3 py-1 rounded font-semibold text-white
                hover:bg-orange-600 mr-4 sm:mt-0 sm:text-sm sm:px-2 sm:ml-2"
              on:click={logout}>
              Logout
            </button>
            <AccountDropdown {address} />
          {:else}
            <a
              href="#/home"
            ...
            <div>
              <label
                class="mt-1 block px-3 py-1 rounded font-semibold text-white
                  hover:bg-orange-600 sm:mt-0 sm:text-sm sm:px-2 sm:ml-2">
      ...
      <div class="sm:flex sm:items-center">
        <div
          ...
          {:else}
            ...
            <div>
              <label
                class="mt-1 block px-4 py-1 rounded font-semibold text-white
                  hover:bg-orange-600 sm:mt-0 sm:text-sm sm:px-2 sm:ml-2">
                Login
                <input
                  type="file"
